...
class H2GCN(nn.Module):
    """ our implementation """
    def __init__(self, g, in_channels, hidden_channels, out_channels, num_nodes,
        ...
        self.feature_embed = MLP(hidden_channels, hidden_channels,
    ...
    def forward(self, features_list):
        ...
        x = self.feat_encode(features_list)
